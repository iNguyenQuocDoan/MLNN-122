...
export const QUESTIONS: QuestionData[] = [
  ...
  { text: 'Theo Marx, hai phương pháp cơ bản để sản xuất giá trị thặng dư là gì?', options: ['Tăng giá bán và giảm lương', 'Giá trị thặng dư tuyệt đối và giá trị thặng dư tương đối', 'Tăng tư bản bất biến và giảm tư bản khả biến', 'Mở rộng thị trường và tăng số lượng công nhân'], correct: 1 },
  { text: 'Giá trị thặng dư tương đối được tạo ra bằng cách nào?', options: ['Kéo dài ngày làm việc của công nhân vượt quá thời gian lao động tất yếu', 'Rút ngắn thời gian lao động tất yếu nhờ tăng năng suất lao động xã hội', 'Tăng số lượng công nhân trong nhà máy', 'Giảm chất lượng nguyên vật liệu đầu vào'], correct: 1 },
  { text: 'Điểm khác biệt cốt lõi giữa giá trị thặng dư siêu ngạch và giá trị thặng dư thông thường là gì?', options: ['Thặng dư siêu ngạch là kết quả của việc tăng giá bán, còn thặng dư thông thường là kết quả của việc bóc lột lao động', 'Thặng dư siêu ngạch thu được nhờ năng suất cá biệt vượt trội hơn mức trung bình xã hội; thặng dư thông thường dựa trên mức trung bình', 'Thặng dư siêu ngạch chỉ tồn tại trong ngành nông nghiệp, thặng dư thông thường chỉ trong công nghiệp', 'Không có sự khác biệt, hai khái niệm này giống nhau hoàn toàn'], correct: 1 },
  { text: 'Tỷ suất giá trị thặng dư (m\') được tính bằng công thức nào?', options: ["m' = m / c × 100%", "m' = m / v × 100%", "m' = v / m × 100%", "m' = (c + v) / m × 100%"], correct: 1 },
